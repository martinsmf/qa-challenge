Feature: Busca
        ...
        Examples:
                  | filtro        | url        | titulo               |
                  | Por concurso  | concurso/  | Cursos por concurso  |
                  | Por professor | professor/ | Cursos por professor |
                  | Por matéria   | materia/   | Cursos por matéria   |
                  | Por região    | regiao/    | Cursos por região    |
                  | Ver todos     |            | Cursos online        |
